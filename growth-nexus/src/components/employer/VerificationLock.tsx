...
import { Shield, Lock, AlertTriangle, FileText, ExternalLink } from 'lucide-react'
...
/**
 * Full-page lock overlay for client components that require verification.
 * Reads verification status from VerificationContext.
 */
export function VerificationLock({ featureName }: VerificationLockProps) {
    ...
    return (
        <div className="flex items-center justify-center min-h-[60vh]" dir="rtl">
            <Card className="bg-navy-light/80 border-gold/10 backdrop-blur-sm max-w-lg w-full mx-4">
                <CardContent className="p-10 text-center space-y-6">
                    ...
                    <Link href={config.ctaLink}>
                        <Button className="bg-gradient-to-r from-gold to-gold-light hover:from-gold-dark hover:to-gold text-navy font-bold w-full mt-2">
                            {config.cta}
